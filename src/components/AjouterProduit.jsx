...
const AjouterProduit = () => {
    ...
    const handleSubmit = (e) => {
      ...
      console.log("Produit ajouté :", { id, nomProduit, ingredients, prix, allergene });
      ...
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <form onSubmit={handleSubmit}>
            ...
            <button style={{ fontSize: '25px' }} type="submit" onClick={''}>Ajouter <i class="fa-solid fa-plus"></i></button>
          </form>
        </div>
      </div>
      </div>
